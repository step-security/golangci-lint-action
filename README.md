...
[![Build Status](https://github.com/step-security/golangci-lint-action/workflows/build-and-test/badge.svg)](https://github.com/step-security/golangci-lint-action/actions)
...
2. They aren't shown in the list of comments.
   If you would like to have comments, please up-vote [the issue](https://github.com/step-security/golangci-lint-action/issues/5).
